...
class MedInferencer(BaseInferencer):
    """Medical Object Detection Inferencer.
    ...
    def _init_pipeline(self, cfg: ConfigType) -> Compose:
        ...
        load_img_idx = self._get_transform_idx(
            pipeline_cfg, ('LoadDicomImage', LoadDicomImage))
        if load_img_idx == -1:
            raise ValueError(
                'LoadDicomImage is not found in the test pipeline')
        pipeline_cfg[load_img_idx]['type'] = 'mmdet.MedInferencerLoader'
